...
import { PhoneRegistrationFlow } from "@/components/phone-registration-flow";
...
export default function AuthModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  // Handle phone registration success
  const handlePhoneRegistrationSuccess = useCallback((data: any) => {
    // User successfully registered via phone flow
    onClose();
  ...
  }, [login, formData.email, formData.password, onClose]);

  // Memoized forget password handler
  ...
  }, [formData.email, setShowForgetPassword]);
        ...
        <TabsContent value="signup" className="space-y-4">
          <div className="space-y-4">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Phone-First Registration</h3>
              <p className="text-sm text-gray-600">Verify your phone number first, then complete registration</p>
            </div>
  ...
  }, [showForgetPassword, isLogin, formData, isLoading, isGoogleLoading, isLoginLoading, authLoading, handleInputChange, handleLogin, handleTabChange, handleForgetPassword, toggleForgetPassword, handleGoogleSignIn, handlePhoneRegistrationSuccess, onClose]);
